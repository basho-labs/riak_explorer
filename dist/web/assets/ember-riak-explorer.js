  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      build: function build(dom) {
        ...
        var el7 = dom.createTextNode("Ping");
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph0 = dom.createMorphAt(dom.childAt(fragment, [2, 1, 3]),3,3);
...
if (runningTests) {
  ...
  require("ember-riak-explorer/app")["default"].create({"name":"ember-riak-explorer","version":"0.0.0.4abdb277"});
}
