    ...
    exports['default'] = Ember['default'].Route.extend({
        model: function model(params) {
            ...
            return this.explorer.getBucketType(clusterId, bucketTypeId, store).then(function (bucketType) {
                return explorer.getBucketTypeWithList(bucketType, bucketType.get('cluster'), store);
            });
        },
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        statements: [
          ["inline","bucket-properties",[],["model",["subexpr","@mut",[["get","model",["loc",[null,[12,30],[12,35]]]]],[],[]]],["loc",[null,[12,4],[12,37]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    var child2 = (function() {
      var child0 = (function() {
        return {
          ...
          statements: [
            ["inline","refresh-buckets",[],["action","refreshBuckets","bucketType",["subexpr","@mut",[["get","model",["loc",[null,[26,69],[26,74]]]]],[],[]]],["loc",[null,[26,16],[26,76]]]]
          ],
          locals: [],
          templates: []
        };
      ...
      return {
        ...
        statements: [
          ["content","model.bucketList.created",["loc",[null,[24,27],[24,55]]]],
          ["block","if",[["get","model.cluster.developmentMode",["loc",[null,[25,18],[25,47]]]]],[],0,null,["loc",[null,[25,12],[27,19]]]],
          ["content","model.bucketList.count",["loc",[null,[34,16],[34,42]]]],
          ["content","model.bucketList.total",["loc",[null,[36,16],[36,42]]]],
          ["block","riak-buckets",[],["bucketList",["subexpr","@mut",[["get","model.bucketList",["loc",[null,[41,35],[41,51]]]]],[],[]],"cluster",["subexpr","@mut",[["get","model.cluster",["loc",[null,[41,60],[41,73]]]]],[],[]],"bucketTypeId",["subexpr","@mut",[["get","model.bucketTypeId",["loc",[null,[42,25],[42,43]]]]],[],[]]],1,null,["loc",[null,[41,8],[43,25]]]]
        ],
        locals: [],
    ...
    var child3 = (function() {
      return {
        ...
        statements: [
          ["content","loading-spinner",["loc",[null,[46,4],[46,23]]]]
        ],
        locals: [],
        templates: []
      };
    ...
    return {
      ...
      statements: [
        ...
        ["content","model.bucketTypeId",["loc",[null,[6,14],[6,36]]]],
        ["block","if",[["get","model.props",["loc",[null,[11,6],[11,17]]]]],[],0,1,["loc",[null,[11,0],[15,7]]]],
        ["block","if",[["get","model.isBucketListLoaded",["loc",[null,[20,6],[20,30]]]]],[],2,3,["loc",[null,[20,0],[47,7]]]]
      ],
      locals: [],
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        statements: [
          ["content","prop.key",["loc",[null,[24,16],[24,28]]]],
          ["content","prop.value",["loc",[null,[25,16],[25,30]]]]
        ],
        locals: ["prop"],
        templates: []
      };
    ...
    return {
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        ...
        morphs[3] = dom.createMorphAt(dom.childAt(fragment, [2, 3]),1,1);
        return morphs;
      },
      statements: [
        ["inline","link-cluster",[],["cluster",["subexpr","@mut",[["get","model.cluster",["loc",[null,[2,27],[2,40]]]]],[],[]]],["loc",[null,[2,4],[2,42]]]],
        ...
        ["block","each",[["get","model.propsList",["loc",[null,[22,8],[22,23]]]]],[],0,null,["loc",[null,[22,0],[27,9]]]]
      ],
      locals: [],
      templates: [child0]
    };
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child2 = (function() {
      ...
      return {
        ...
        statements: [
          ["block","bucket-types",[],["clusterId",["subexpr","@mut",[["get","model.clusterId",["loc",[null,[28,42],[28,57]]]]],[],[]],"bucketTypes",["subexpr","@mut",[["get","model.activeBucketTypes",["loc",[null,[29,32],[29,55]]]]],[],[]]],0,null,["loc",[null,[28,16],[29,74]]]]
        ],
        locals: [],
        templates: [child0]
      };
    ...
    var child4 = (function() {
      ...
      return {
        ...
        statements: [
          ["block","bucket-types",[],["clusterId",["subexpr","@mut",[["get","model.clusterId",["loc",[null,[40,42],[40,57]]]]],[],[]],"bucketTypes",["subexpr","@mut",[["get","model.inactiveBucketTypes",["loc",[null,[41,32],[41,57]]]]],[],[]]],0,null,["loc",[null,[40,16],[41,76]]]]
        ],
        locals: [],
        templates: [child0]
      };
    ...
    var child5 = (function() {
      ...
      return {
        ...
        statements: [
          ["block","search-indexes",[],["indexes",["subexpr","@mut",[["get","model.indexes",["loc",[null,[52,42],[52,55]]]]],[],[]],"clusterProxyUrl",["subexpr","@mut",[["get","model.proxyUrl",["loc",[null,[53,36],[53,50]]]]],[],[]]],0,null,["loc",[null,[52,16],[54,35]]]]
        ],
        locals: [],
        templates: [child0]
      };
    ...
    var child7 = (function() {
      return {
        ...
        statements: [
          ["inline","riak-node",[],["node",["subexpr","@mut",[["get","node",["loc",[null,[73,23],[73,27]]]]],[],[]]],["loc",[null,[73,6],[73,29]]]]
        ],
        locals: ["node"],
        templates: []
      };
    ...
    return {
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        ...
        morphs[5] = dom.createMorphAt(dom.childAt(element0, [5, 1]),3,3);
        morphs[6] = dom.createMorphAt(element0,7,7);
        morphs[7] = dom.createMorphAt(dom.childAt(element0, [11, 1]),1,1);
        morphs[8] = dom.createMorphAt(dom.childAt(element0, [13, 1, 3, 3]),1,1);
        return morphs;
      },
      statements: [
        ["attribute","title",["concat",["Cluster: ",["get","model.clusterId",["loc",[null,[5,38],[5,53]]]]]]],
        ["attribute","title",["concat",["Cluster: ",["get","model.clusterId",["loc",[null,[7,38],[7,53]]]]]]],
        ["attribute","title",["concat",["Cluster: ",["get","model.clusterId",["loc",[null,[8,40],[8,55]]]]]]],
        ["content","model.clusterId",["loc",[null,[9,20],[9,39]]]],
        ["block","if",[["get","model.developmentMode",["loc",[null,[16,22],[16,43]]]]],[],0,1,["loc",[null,[16,16],[20,23]]]],
        ["block","if",[["get","model.activeBucketTypes",["loc",[null,[27,18],[27,41]]]]],[],2,3,["loc",[null,[27,12],[32,19]]]],
        ["block","if",[["get","model.inactiveBucketTypes",["loc",[null,[35,10],[35,35]]]]],[],4,null,["loc",[null,[35,4],[44,11]]]],
        ["block","if",[["get","model.indexes",["loc",[null,[50,18],[50,31]]]]],[],5,6,["loc",[null,[50,12],[57,19]]]],
        ["block","each",[["get","model.nodes",["loc",[null,[72,12],[72,23]]]]],[],7,8,["loc",[null,[72,4],[76,13]]]]
      ],
      locals: [],
...
define('ember-riak-explorer/templates/components/link-cluster', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      statements: [
        ["block","link-to",["cluster",["get","cluster",["loc",[null,[1,21],[1,28]]]]],["classNames","btn btn-sm btn-primary cluster-resource-link"],0,null,["loc",[null,[1,0],[5,12]]]]
      ],
      locals: [],
      templates: [child0]
    };
...
define('ember-riak-explorer/templates/components/riak-buckets', ['exports'], function (exports) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      ...
      return {
        ...
        statements: [
          ...
          ["block","link-to",["key_list",["subexpr","query-params",[],["cluster_id",["get","bucket.clusterId",["loc",[null,[17,67],[17,83]]]],"bucket_type_id",["get","bucket.bucketTypeId",["loc",[null,[18,43],[18,62]]]],"bucket_id",["get","bucket.bucketId",["loc",[null,[18,73],[18,88]]]]],["loc",[null,[17,42],[18,89]]]]],["classNames","btn btn-xs btn-primary"],1,null,["loc",[null,[17,20],[20,44]]]]
        ],
        locals: ["bucket"],
        templates: [child0, child1]
      };
    ...
    return {
      ...
      statements: [
        ["block","each",[["get","bucketList.buckets",["loc",[null,[3,8],[3,26]]]]],[],0,1,["loc",[null,[3,0],[28,9]]]]
      ],
      locals: [],
      templates: [child0, child1]
    };
